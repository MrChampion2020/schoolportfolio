  ...
  return (
    <div style={{ width: "100%", backgroundColor: "black", color: "#F0F4F8" }}>
      ...
      >
        ...
        >
          <h2
            className="sm:text-4xl font-extrabold text-white-900 dark:text-white lg:text-6xl text-center mt-20 mb-12"
          >
            My Reflections
          </h2>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "10px" }}>
            {services.map((service, index) => (
              ...
              >
                ...
                >
                  {service.question}
                  <span style={{fontSize: '40px', backgroundColor: 'black', borderRadius: "5%", padding: 5}}>{openQuestion === index ? "−" : "+"}</span>
                </button>
                <AnimatePresence>
                  {openQuestion === index && (
                    <motion.div
